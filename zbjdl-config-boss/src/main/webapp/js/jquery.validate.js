...
Validate = function(){
  return{
    ...
    regexs: {
      ...
      "post": /^[0-9]{6}$/,
      "date": /^((((1[6-9]|[2-9]\d)\d{2})-(0{1}[13578]|1[02])-(0{1}[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0{1}[13456789]|1[012])-(0{1}[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0{1}[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))$/,
      ...
      "datetime": /^((((1[6-9]|[2-9]\d)\d{2})-(0[13578]|1[02])-(0[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0[13456789]|1[012])-(0[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))(\s(((0[0-9])|([1-2][0-3]))\:([0-5][0-9])((\s)|(\:([0-5][0-9])))?)){1}$/,
      "dateortime": /^((((1[6-9]|[2-9]\d)\d{2})-(0[13578]|1[02])-(0[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0[13456789]|1[012])-(0[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))(\s(((0[0-9])|([1-2][0-3]))\:([0-5][0-9])((\s)|(\:([0-5][0-9])))?))?$/,
      "int": /^\d+$/,
      "float": /^\d+\.\d+$/,
      "decimal": /^\d+(\.\d+)?$/,
      "chinese": /^\u4e00-\u9fa5$/,
