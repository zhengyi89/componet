...
public class ImgVerifyCode {
	...
	private Logger logger = LoggerFactory.getLogger(ImgVerifyCode.class);
	...
	/**
	 * 生成图片验证码，通过response输出到页面
	 * @param req
	 * @param resp
	 * @return 验证码
	 */
	public String images(HttpServletRequest req, HttpServletResponse resp) {
		init();
		// 定义图像buffer
